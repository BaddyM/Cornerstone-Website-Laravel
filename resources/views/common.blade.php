...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href={{ asset("assets/img/school-badge.ico") }} type="image/x-icon">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="mu-header-top-left">
                  <div class="mu-top-email">
                    ...
                    <span>info@cornerstonehighschoolnangabo.com</span>
                  </div>
                  <div class="mu-top-phone">
                    <i class="fa fa-phone"></i>
                    <a href="tel:+256755009295">+256755009295</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="index.html"><i class="fa fa-university"></i><span>Cornerstone High School Nangabo</span></a>
          <!-- IMG BASED LOGO  -->
